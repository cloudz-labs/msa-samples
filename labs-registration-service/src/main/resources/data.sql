...
* **사전교육** : Labs에서 Cloud Application 전환에 필요한 기술에 대한 사전 교육으로 진행됩니다.
* **Incoming**
	...
	* 단계별로 Labs의 각 분야 전문가들이 Point Coaching이 진행됩니다.
	* 매일 정해진 시간에 Labs의 담당자와 스크럼 미팅을 통해서 이슈를 공유하고 해결합니다.
* **Outgoing**
...
insert into Questions (category, contents, version, reg_date) values 
('3'
,'{"questionnaire":[{"questions":[{"name":"Name","id":"002","type":"text","hasEtc":false,"reply":["홍길동"],"required":true},{"name":"Team","id":"003","type":"text","hasEtc":false,"reply":["Cloud Platform팀"],"required":true},{"name":"교육 수강 희망 기간","id":"004","type":"text","hasEtc":false,"reply":["20170515~20170630"],"required":true},{"name":"교육 수강 희망 인원","id":"005","type":"text","hasEtc":false,"reply":["5"],"required":true}],"step":1,"category":"일반정보"},{"questions":[{"name":"LABS 담당자에게 전하고 싶은 말이 있다면 기입해 주십시오.","id":"101","type":"textarea","hasEtc":false,"reply":[""],"required":false}],"step":2,"category":"기타"}],"notice":null}'
,'v1.0.0'
,curdate()
);